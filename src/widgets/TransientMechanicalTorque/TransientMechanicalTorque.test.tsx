...
import TransientMechanicalTorque from './TransientMechanicalTorque';
...
describe('TransientMechanicalTorque', () => {
      ...
      <ConfigsProvider>
        <ReconnectingChartGroupProvider>
          <NoStreamingTimerChartGroupProvider>
            <TransientMechanicalTorque {...mockedProps} />
          </NoStreamingTimerChartGroupProvider>
        </ReconnectingChartGroupProvider>
      </ConfigsProvider>,
    );
    expect(getByTestId('baseWidget_TransientMechanicalTorque')).toBeInTheDocument();
    expect(
      getByTestId(`container_${WidgetsLoaderEnum.TransientMechanicalTorque}`),
    ).toBeInTheDocument();
