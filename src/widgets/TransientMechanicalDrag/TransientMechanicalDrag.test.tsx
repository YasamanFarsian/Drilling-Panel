...
import TransientMechanicalDrag from './TransientMechanicalDrag';
...
describe('TransientMechanicalDrag', () => {
      ...
      <ConfigsProvider>
        <ReconnectingChartGroupProvider>
          <NoStreamingTimerChartGroupProvider>
            <TransientMechanicalDrag {...mockedProps} />
          </NoStreamingTimerChartGroupProvider>
        </ReconnectingChartGroupProvider>
      </ConfigsProvider>,
    );
    expect(getByTestId('baseWidget_TransientMechanicalDrag')).toBeInTheDocument();
    expect(
      getByTestId(`container_${WidgetsLoaderEnum.TransientMechanicalDrag}`),
    ).toBeInTheDocument();
